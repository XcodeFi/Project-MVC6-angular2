        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrlSlug = table.Column<string>(maxLength: 450, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AppicationUserId = table.Column<string>(nullable: true),
                    ...
                    Title = table.Column<string>(maxLength: 250, nullable: false),
                    UrlSlug = table.Column<string>(maxLength: 250, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Blogs_AspNetUsers_AppicationUserId",
                        column: x => x.AppicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Blogs_CategoryBlogs_CateBlogId",
                        column: x => x.CateBlogId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cards_AspNetUsers_ApplycationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Blogs_AppicationUserId",
                table: "Blogs",
                column: "AppicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Blogs_CateBlogId",
                table: "Blogs",
                column: "CateBlogId");

            migrationBuilder.CreateIndex(
                name: "IX_Cards_ApplycationUserId",
                table: "Cards",
                column: "ApplycationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Cards_CateId",
                table: "Cards",
                column: "CateId");
